            ...
            <div x-cloak x-data="{ areaValid: false, cityValid: false, streetValid: false, nameValid: false, phoneValid: false }"
                ...
                <form x-cloak action="{{ route('approve') }}" method="POST"
                    ...
                    <div class="flex gap-3">
                        <div class="mb-4 flex-1">
                            <input
                                    ...
                                    name="area"
                                    x-model="area"
                                    x-on:input="areaValid = area.length >= 6"
                                    :class="{ 'border-green-500 border-[.25rem] focus:ring-green-500 focus:border-green-500': areaValid,  'border-gray-300 focus:border-gray-300 focus:ring-gray-300 ': !areaValid }"
                    ...
                    <div
                            ...
                            class=" mt-[-28px] btn-primary bg-gray-500 hover:bg-gray-600 active:bg-gray-700 w-full"
                            :class="{ 'opacity-0': areaValid && cityValid && streetValid && nameValid && phoneValid, 'opacity-100': !(areaValid && cityValid && streetValid && nameValid && phoneValid) }"
                            :disabled="(areaValid && cityValid && streetValid && nameValid && phoneValid)"
                    >
                        @lang('main.send_order')
                    </div>
