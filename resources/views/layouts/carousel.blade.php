...
<main class="grid h-[30rem] w-full place-content-center bg-white-200 max-[525px]:hidden">
    <div x-data="imageSlider" class="relative mx-auto w-[90rem] mt-[60px] overflow-hidden rounded-md bg-gray-100 p-2 sm:p-4">
        ...
        <div class="relative h-80" style="width: 30rem">
                    ...
                    <img  src="{{ asset('storage/a3.jpg') }}" alt="image" class="rounded-sm" />
...
<div id="default-carousel" class="relative w-full" data-carousel="slide">
    ...
    <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
        ...
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="{{ asset('storage/a3.jpg') }}"class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
        </div>
        <!-- Item 2 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="{{ asset('storage/a3.jpg') }}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
